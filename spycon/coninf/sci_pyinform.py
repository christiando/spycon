...
class TE_PyInform(SpikeConnectivityInference):
    def __init__(self, params: dict = {}):
        ...
        :param params:
            ...
            'jitter_factor': How many time bins maximally the spikes can be jittered. (Default=7)
            'num_surrogates': How many surrogates should be created. (Default=50)
            'jitter': If true spikes are uniformly jittered. Otherwise, spikes are randomly selected from population. (Default=False)
        :type params: dict
        """
    ...
    def _infer_connectivity_parallel(
        ...
        :param pairs: Array of [pre,post] pair node IDs, which inference will be done for.
        :type pairs: numpy.ndarray
        :param num_cores: How many cores should be used for multiprocessing.
        :type num_cores: int
    ...
    def _test_connection_pair(
        ...
        for isurr in range(num_surrogates):
            ...
            te1_H0[isurr] = pyinform.transfer_entropy(
                spk_train1_shuffled, spk_train2, k=k
            )
        ...
        for isurr in range(num_surrogates):
            ...
            te2_H0[isurr] = pyinform.transfer_entropy(
                spk_train2_shuffled, spk_train1, k=k
            )
